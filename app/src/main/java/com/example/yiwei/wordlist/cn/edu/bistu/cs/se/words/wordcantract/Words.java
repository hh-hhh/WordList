package com.example.yiwei.wordlist.cn.edu.bistu.cs.se.words.wordcantract;
...
public class Words {
    ...
    public static final String AUTHORITY = "com.example.yiwei.wordlist.MyContentProvider";//URI授权者
